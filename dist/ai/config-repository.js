...
function relativeConfigPath(rootPath, configPath) {
    return toPortableRelativePath(path.relative(rootPath, configPath) || configPath);
}
export function createAiConfigRepository(rootPath) {

 ...
 */
export declare function replaceFileAtomically(temporaryPath: string, targetPath: string, options?: ReplaceFileAtomicallyOptions): void;
//# sourceMappingURL=atomic-replace.d.ts.map
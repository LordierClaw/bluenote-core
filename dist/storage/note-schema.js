...
export function assertKnownFields(record, allowedFields, sourcePath, kind) {
...
export function assertRequiredFields(record, requiredFields, sourcePath, kind) {
...
export function assertStringField(record, field, sourcePath, kind) {
...
export function assertNumberField(record, field, sourcePath, kind) {
    const value = record[field];
...
export function assertStringArrayField(record, field, sourcePath, kind) {
    const value = record[field];
...
export function assertTimestampField(record, field, sourcePath, kind) {
...
const FRONTMATTER_OPTIONAL_FIELDS = ["archivedAt"];
export function validateNoteFrontmatter(frontmatter, sourcePath) {
